...
volatile Ifx_SRC_SRCR *const GPSR[4] = {&SRC_GPSR_GPSR0_SR0, &SRC_GPSR_GPSR1_SR0, &SRC_GPSR_GPSR2_SR0, &SRC_GPSR_GPSR3_SR0};
...
{
    IfxStm_increaseCompare(&MODULE_STM0, IfxStm_Comparator_0, configTICK_RATE_HZ);
