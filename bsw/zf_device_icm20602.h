...
//===============================================声明 ICM20602 数据存储变量==============================================
extern sint16 icm20602_gyro_x, icm20602_gyro_y, icm20602_gyro_z;                                // 三轴陀螺仪数据
extern sint16 icm20602_acc_x,  icm20602_acc_y,  icm20602_acc_z;                                 // 三轴加速度计数据

extern float32 acc_x, acc_y, acc_z;
extern float32 gyro_x, gyro_y, gyro_z;
...
float32   icm20602_gyro_transition    (sint16 gyro_value);                         // 将 ICM20602 陀螺仪数据转换为实际物理数据
float32   icm20602_acc_transition     (sint16 acc_value);                          // 将 ICM20602 加速度计数据转换为实际物理数据
